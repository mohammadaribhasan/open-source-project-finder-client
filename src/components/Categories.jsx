...
const Categories = () => {
    return (
        ...
        >
            ...
            {/* Title aligned right */}
            <h2 className="text-4xl md:text-5xl text-indigo-300 font-extrabold mb-16 text-right relative z-10">
                Explore Categories
            </h2>

            {/* Centered cards */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 justify-items-center relative z-10">
