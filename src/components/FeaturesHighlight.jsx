...
const FeaturesHighlight = () => {
    return (
        <section
            id="features"
            className="relative min-h-screen py-20 bg-gradient-to-bl from-indigo-600 via-[#F5EFE6] to-[#F5EFE6] text-white px-6 overflow-hidden"
        >
            ...
            <div className="w-full max-w-7xl mx-auto relative z-10">
                ...
                {/* Features Grid */}
                <div className="grid md:grid-cols-3 gap-10 w-full justify-items-center">
                    {features.map((f, i) => (
                        <motion.div
                            key={i}
                        ...
                        >
                            {/* Icon */}
                            <div className="mb-5 bg-gray-900 p-4 rounded-full shadow-lg">
                                {f.icon}
                            </div>
