...
const CommunityShowcase = () => {
    return (
        <section
            id="community"
            className="relative bg-gradient-to-tr from-indigo-600 via-[#F5EFE6] to-[#F5EFE6] text-white px-6 py-24 overflow-hidden"
        >
            ...
            <div className="w-full max-w-7xl mx-auto relative z-10 flex flex-col items-center">
                {/* Title aligned right */}
                <motion.h2
                    className="text-4xl md:text-5xl font-extrabold mb-16 text-indigo-300 text-right w-full"
